...
function AdminNavbar({onMenuClick}) {
    return (
        ...
        <nav class="border-b  border-gray-300 border-l-0 left-0 top-0 z-50 w-full  bg-gray-800 dark:border-gray-700">
            <header class="antialiased">
                <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div class="flex flex-wrap justify-between items-center">
                        <div class="flex justify-start items-center">
                            <button onClick={()=> onMenuClick((prev)=> !prev)} id="toggleSidebar" aria-expanded="true" aria-controls="sidebar" class="  p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                            ...
                            <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                                ...
                                <div class="relative mt-1 lg:w-96">
                                    ...
                                    <input type="text" name="email" id="topbar-search" class="pl-10 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" />
                                </div>
                            </form>
                        </div>
