...
import { signUpIndexUp, onSignUpHandler, signUpInitialValues, signUpValidator } from './Logic'
...
function SignUpStart({ state }) {
    ...
    return (
        <div>
            ...
            <Formik onSubmit={(val) => onSignUpHandler(val, onSignUpFormSubmit)} initialValues={signUpInitialValues} validationSchema={signUpValidator} class="max-w-sm mt-10" >
                <Form>
