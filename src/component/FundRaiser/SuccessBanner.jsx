...
function SuccessBanner({ title, shareURL }) {
    return (
        <div className='bg-green-200 flex items-center justify-center flex-col pt-5 pb-5 bg-opacity-5'>
            ...
            <button onClick={navigator.clipboard.write(shareURL)} type="button" class="mt-5 py-2.5 px-5 me-2 mb-2 text-sm font-medium text-blue-700 focus:outline-none bg-transparent rounded-lg border border-blue-700 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Copy URl</button>
