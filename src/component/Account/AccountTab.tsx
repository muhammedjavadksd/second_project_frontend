    ...
    return (
        <div>
            ...
            <div className="md:flex">
                <ul className="w-full space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400  mb-4 md:mb-0">
                    <li>
                    ...
                    <li>
                        <a href="#" onClick={() => {
                            ...
                            <i className="fa-solid fa-droplet me-3"></i>
                            Open Blood Account
                        </a>
                    </li>
                    <li>
