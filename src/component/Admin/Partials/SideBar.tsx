...
function AdminSideBar({ isShow }) {
    ...
    const homeSvgIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
    ...
    const addFundRaiserSvgIocn = <i className="fa-solid fa-person-circle-plus"></i>
    const manageFundRaiserSvgIcon = <i className="fa-solid fa-users"></i>
    const fundRaiserPaymentSvgIcon = <i className="fa-solid fa-money-bill"></i>

    const addBloodDonorSvgIcon = <i className="fa-solid fa-droplet"></i>
    const addBloodPatientSvgIcon = <i className="fa-solid fa-bed"></i>
    const urgentBloodRequirementSvgIcon = <i className="fa-solid fa-truck-medical"></i>
    const bloodBankIcon = <i className="fa-solid fa-vault"></i>
    const nearest = <i className="fa-solid fa-map"></i>
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6">
                        <nav className="-mx-3 space-y-6 ">
                            ...
                            <div className="space-y-3 ">
                                <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Basic</label>
                            ...
                            <div className="space-y-3 ">
                                <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Fund Raiser</label>
                            ...
                            <div className="space-y-3 ">
                                <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Blood Bank</label>
