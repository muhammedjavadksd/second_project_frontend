        ...
        <div style={{ height: "600px" }} className="flex  bg-gray-100 w-full">
            <div className="w-full  bg-gray-100 dark:bg-gray-800 p-4">
                ...
                <div className="flex items-center">
                    <Image className="w-16 h-16 rounded-full object-cover border-2 border-white dark:border-gray-900" src="https://via.placeholder.com/100?text=User" alt="Profile" />
                    <div className="ml-4">
