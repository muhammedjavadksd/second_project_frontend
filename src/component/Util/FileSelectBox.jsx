    ...
    return (
        <div>
            <div class="flex items-center justify-center w-full">
                <label for={`dropzone-file-${id}`} class="pt-6 pb-6 align-middle h-full flex-col items-center justify-center  pl-5 pr-5 h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
