...
function TableSimple({ headers, data, onItemChecked, onAllItemCheck, selectedItem }: ITableProps) {
                        ...
                        <div className="flex items-center">
                            <input
                                onClick={(val) => {
                                    ...
                                    if (checked) {
                                        const ids = data.map((each) => each['raisingID'])
                                        onAllItemCheck(ids)
                                    } else {
                                        onAllItemCheck([])
                                    }
