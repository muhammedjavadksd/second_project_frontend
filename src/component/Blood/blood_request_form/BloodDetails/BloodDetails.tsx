...
import { HospitalResponse, SelectedHospital } from "@/util/types/InterFace/UtilInterface"
...
function BloodRequestDetails({ state }): React.ReactElement {
    ...
    const [selectedLocation, setSelectedLocation] = useState<HospitalResponse>(null);
            ...
            <LoadingComponent closeOnClick={false} isLoading={isLoading} paddingNeed={false} >
                <CreateFormBackground>
                    <Formik onSubmit={(val) => {
                        ...
                        if (!selectedLocation) {
                            toast.error("Select valid hospital")
                            return;
                        }
                        setLoding(true)
                        val.personal_details = bloodRequestFirstPhase;
                        onBloodDetailsSubmit(val, selectedLocation, successCallback, errorCallback, ifNotLogged)
                    }
                            ...
                            return (
                                <Form>
                                    ...
                                    <div className="mb-5 w-full relative">
                                        ...
                                        <HospitalSearch selectedHospital={(hospital) => setSelectedLocation(hospital)} />
