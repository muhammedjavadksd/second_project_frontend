        ...
        <LoadingComponent closeOnClick={false} isLoading={isLoading} paddingNeed={false}>
            <div className=' bg-white rounded-t p-5 rounded-b min-h-10 min-w-96 '>
                <>
                    ...
                    <Formik initialValues={updateBloodGroupInitialValues} validationSchema={updateBloodGroupValidation} onSubmit={(val) => { setLoading(true), OnBloodGroupUpdate(val, successCB, errorCb) }}>
                        {({ setFieldValue }) => {
                            return (
                                <Form>
                                    <div className='mb-5'>
