...
function FundRaiseCreatedSuccessPage() {
    let [tabListing, setTabListing] = useState('ABOUT')
    ...
    return (
        <main className="flex min-h-screen flex-col">
            <div>
                ...
                {/* <Footer */}
                <Header />
                <SuccessBanner title={"Congrats! Your fundraiser is now active and you can begin receiving donations."} shareURL={"https://www.ketto.org/fundraiser/i-need-your-urgent-support-for-my-accident-treatment-911104"}></SuccessBanner>
                            ...
                            <div className='w-3/4 mb-5'>
                                <div className='bg-white shadow rounded-sm'>
                                    ...
                                    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                        <li class="me-2">
                                            <button onClick={() => setTabListing("ABOUT")} aria-current="page" class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500">About</button>
                                        </li>
                                        <li class="me-2">
                                            <button onClick={() => setTabListing("DOCUMENT")} class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Document</button>
                                        </li>
                                        <li class="me-2">
                                            <button onClick={() => setTabListing("UPDATE")} class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Update's</button>
                                        </li>
                                        <li class="me-2">
                                            <button onClick={() => setTabListing("COMMENT")} class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Comment's</button>
                                        </li>
                                    </ul>

                                    <div className='tabWrapperGroup'>
                                        <TabItem isShow={tabListing == "ABOUT"}>
                                        ...
                                        <TabItem isShow={tabListing == "DOCUMENT"}>
                                            <h4>Document's</h4>
                                        </TabItem>
                                        <TabItem isShow={tabListing == "UPDATE"}>

                                            <h4>Updates</h4>
                                        </TabItem>
                                        <TabItem isShow={tabListing == "COMMENT"}>
                                            <h4>Comment's</h4>
                                        </TabItem>
                                    </div>
...
export default FundRaiseCreatedSuccessPage