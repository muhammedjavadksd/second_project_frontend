                        ...
                        <div className='w-1/4'>
                            <div className="bg-white shadow-xl rounded-lg py-3">
                                <div className="photo-wrapper items-center flex justify-center w-full p-2">
                                    ...
                                    <LoadImage skeltonHeight={70} className="w-36 h-36 rounded-full" imageurl={fundRaiserProfile?.picture?.length && fundRaiserProfile?.picture[0]} alt="Extra large avatar" />
